! function (e, t) {
                    ...
                    for (let i = 0; i < p; i += 1) {
                        ...
                        if (C && e.grid.updateSlide(i, n, p, t), "none" !== n.css("display")) {
                            if ("auto" === a.slidesPerView) {
                                ...
                                if (l && (n[0].style.transform = "none"), o && (n[0].style.webkitTransform = "none"), a.roundLengths) S = e.isHorizontal() ? n.outerWidth(!0) : n.outerHeight(!0);
                                else {
                                    const e = s(r, "width"),
                                        t = s(r, "padding-left"),
                                        a = s(r, "padding-right"),
    ...
    class H {
        constructor(...e) {
            ...
            const r = f({}, D, i);
            return a.params = f({}, r, N, s), a.originalParams = f({}, a.params), a.passedParams = f({}, s), a.params && a.params.on && Object.keys(a.params.on).forEach(e => {
    ...
    const Z = [function ({
        ...
        function c() {
            ...
            if (e.params.loop ? (p = Math.ceil((e.activeIndex - e.loopedSlides) / e.params.slidesPerGroup), p > i - 1 - 2 * e.loopedSlides && (p -= i - 2 * e.loopedSlides), p > u - 1 && (p -= u), p < 0 && "bullets" !== e.params.paginationType && (p = u + p)) : p = void 0 !== e.snapIndex ? e.snapIndex : e.activeIndex || 0, "bullets" === s.type && e.pagination.bullets && e.pagination.bullets.length > 0) {
                ...
                let i, l, u;
                if (s.dynamicBullets && (r = a.eq(0)[e.isHorizontal() ? "outerWidth" : "outerHeight"](!0), c.css(e.isHorizontal() ? "width" : "height", r * (s.dynamicMainBullets + 4) + "px"), s.dynamicMainBullets > 1 && void 0 !== e.previousIndex && (n += p - (e.previousIndex - e.loopedSlides || 0), n > s.dynamicMainBullets - 1 ? n = s.dynamicMainBullets - 1 : n < 0 && (n = 0)), i = Math.max(p - n, 0), l = i + (Math.min(a.length, s.dynamicMainBullets) - 1), u = (l + i) / 2), a.removeClass(["", "-next", "-next-next", "-prev", "-prev-prev", "-main"].map(e => `${s.bulletActiveClass}${e}`).join(" ")), c.length > 1) a.each(e => {
                    const t = d(e),
                        a = t.index();
...
function fixedHeader() {
    ...
    e.classList.contains("fixed") || window.addEventListener("scroll", (function () {
        ...
        console.log(t), t > 4 ? (e.classList.add("fixed"), document.querySelector(".body").style.paddingTop = "100px") : (e.classList.remove("fixed"), document.querySelector(".body").style.paddingTop = "0px")
    }))
}
document.querySelectorAll(".anchor").forEach(e => observer.observe(e)), fixedHeader(), $((function () {
    $(".menu-icon").on("click", (function () {
        $(".header__main-menu").slideToggle()
    })), $(".menu__arrow").on("click", (function () {
        $(this).parent(".header-menu__link").has(".header-submenu") && $(this).next().slideToggle(150)
    }))
}));